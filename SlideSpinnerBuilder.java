...
{
	public static SlideSpinner createIntegerField(Window owner, ResourceBundle guiHelperResource, int value, int min, int max, int step, int width)
	{
		...
		field.getTextField().setComponentPopupMenu(GUIHelper.createEditorPopupMenu(field.getTextField(), true, guiHelperResource.getString("UNDO_CAPTION"), true, guiHelperResource.getString("REDO_CAPTION"), true, guiHelperResource.getString("CUT_CAPTION"), true, guiHelperResource.getString("COPY_CAPTION"), true, guiHelperResource.getString("PASTE_CAPTION"), true, guiHelperResource.getString("SELECT_ALL_CAPTION"), null));
		return field;
	}
	...
	public static SlideSpinner createFloatEntryField(Window owner, ResourceBundle guiHelperResource, double current, double min, double max, double step, int width)
	{
	...
	public static SlideSpinner createFloatEntryField(Window owner, ResourceBundle guiHelperResource, double current, double min, double max, double step, int width, boolean forceRound)
	{
	...
	public static SlideSpinner createFloatEntryFieldSpinnerOnly(ResourceBundle guiHelperResource, double current, double min, double max, double step, int width, boolean forceRound)
	{
		FloatOnlyDocument document = new FloatOnlyDocument(getDigits(max), 3, min < 0.0 || max < 0.0, true);
		SlideSpinnerFloatModel model = new SlideSpinnerFloatModel(current, min, max, step);
	...
	public static SlideSpinner createExpIntegerField(Window owner, ResourceBundle guiHelperResource, double expAValue, double expBValue, int value, int min, int max, int step, int width)
	{
	...
	public static SlideSpinner createExpFloatField(Window owner, ResourceBundle guiHelperResource, double expAValue, double expBValue, double value, double min, double max, double step, int width)
	{
